...
import game.world.cell.SimpleCell;
import game.world.cell.UnreachableCell;
...
public class HeroAndMonsterGame {
    ...
    private void opera() {
        while (true) {
            ...
            Boolean result = board.process(str);
            if(!result){
    ...
    public void move(String str) {
        ...
        if(newX == null || newY == null){
            ...
            if(board.canMove(newX, newY)){
                ...
                board.moveTeam(newX, newY);
                //battle only starts in common cells
                if (board.get(newX, newY).isSimple()) {
                    if (isCreateBattle()) {
